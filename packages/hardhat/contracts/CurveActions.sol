...
contract curveActions {
	...
	address constant amCBDCAddr = 0x60D55F02A771d515e077c9C2403a1ef324885CeC;
	...
	function withdrawGauge() internal {
		checkCRVRewards();
		swapCRVtoAM3CRV();
		uint stakeTokenAmt = IERC20(am3CRVGaugePoolAddr).balanceOf(
			address(this)
		);
	...
	function getCBDCSupply() public view returns (uint256) {
